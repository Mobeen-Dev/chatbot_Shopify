...
async def async_chat_endpoint(request: Request, chat_request: ChatRequest):
    ...
    try:
        ...
        async with AsyncOpenAI(
            ...
            chat_request.append_message({"role": "user", "content": user_message})
    ...
    return ChatResponse(
        ...
        stuctural_data=[
            ...
            },
            {
                ...
                "lineItems": [
                    {
                        "merchandise_title": "Blue T-Shirt",
                        "quantity": 2,
                        "merchandise_price": "$29.99",
                    },
                    {
                        "merchandise_title": "Black Jeans",
                        "quantity": 12,
                        "merchandise_price": "$59.99",
                    },
                ],
                "type": "Cart",
            },
